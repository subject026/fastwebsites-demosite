...
registerBlockType("base-jam-blocks/cta", {
	...
	edit: (props) => {
		...
		const { description, imgSrc } = props.attributes;
		return (
			<div className="media-wrapper">
				...
				<TextControl value={description} onChange={handleInputChange} />
			</div>
		);
	},
	 ...
	 */
	save: (props) => {
		const { imgSrc, description } = props.attributes;
		console.log(props);
		return (
			<div>
				<img src={imgSrc} />
				<h1>laaaaaaaaaaaaaaa</h1>
				<p>{description}</p>
			</div>
		);
	},
